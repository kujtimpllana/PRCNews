    ...
    <div className="mt-[20px] p-8 flex flex-col gap-[20px] md:flex md:flex-row md:items-start">
      <div className="mb-14 flex-[5] flex flex-col gap-[20px] md:w-0">
        <input
          type="text"
          placeholder="Title"
          className="p-[10px] border-2 border-gray-200"
      ...
      <div className="flex-[2] flex flex-col gap-[20px]">
        <div className="border-2 border-gray-200 p-[10px] flex-[1] flex flex-col gap-[20px] justify-between text-gray-800">
          ...
          <label
            htmlFor="file"
            className="bg-gray-200 w-[140px] h-auto text-center cursor-pointer p-1"
          >
            Upload Image
          </label>
          <input
          ...
          <div className="flex justify-evenly">
            <button
              onClick={handleEdit}
              className="bg-green-800 hover:bg-green-700 text-gray-100 px-4 py-1"
            >
              Save
            </button>
            <button
              onClick={handleClick}
              className="bg-yellow-700 hover:bg-yellow-600 text-gray-100 px-4 py-1"
            >
              Publish
            </button>
          </div>
