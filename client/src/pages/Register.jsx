  ...
  return (
    <div className='flex flex-col p-10 w-full h-[100vh] justify-center items-center bg-gray-500'>
        ...
        <form action="" className='flex flex-col'>
            ...
            <label className='mt-2 p-1' htmlFor='password'>Re-enter Password:</label>
            <input className='mt-2 indent-2 p-1 rounded-full text-slate-950' type='password' id='password' placeholder='********' required/>

            <p className='my-2'>Already have an account? <Link to='/login'><span className='underline cursor-pointer'>Login here</span></Link>.</p>

            <button type='submit' className=' w-full mt-4 py-1 px-3 border-2 border-gray-950 text-gray-950 hover:bg-slate-950 hover:text-slate-100 rounded-full'>Register</button>
        </form>
    </div>
  )
}
